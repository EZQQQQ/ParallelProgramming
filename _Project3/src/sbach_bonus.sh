...
#   srun -n 1 --cpus-per-task $num_cores /nfsmnt/123100001/CSC4005-2023Fall/project3/build/src/mergesort/mergesort_parallel $num_cores 100000000
# done
# echo ""
...
do
  echo "Number of cores: $num_cores"
  srun -n 1 --cpus-per-task $num_cores /nfsmnt/123100001/CSC4005-2023Fall/project3/build/src/quicksort/quicksort_parallel $num_cores 100000000
done
echo ""